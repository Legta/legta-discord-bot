...
client.once(Events.ClientReady, readyClient => {
	...
	client.user.setPresence({ activities: [{name: 'sliping... ".say" to make me talk', type: ActivityType.Custom }], status: 'dnd'}); //Sets the bot's activity, such as playing, watching, etc. Need to import "ActivityType" from discord.js to change the type.
});
